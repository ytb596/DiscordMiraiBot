...
╚══██╔══╝██╔═══██╗██╔══██╗    ████╗ ████║██╔══██╗████╗  ██║██╔══██╗██╔════╝ ██╔════╝██╔══██╗
   ...
   ╚═╝    ╚═════╝ ╚═╝         ╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝  ╚═╝ ╚═════╝ ╚══════╝╚═╝  ╚═╝
        ...
        console.log(`${this.colors.bright}${this.colors.cyan}                    MIRAI BOT v${version}${this.colors.reset}`);
        console.log(`${this.colors.dim}            Advanced Discord Bot with Premium Features${this.colors.reset}\n`);
    }
}
